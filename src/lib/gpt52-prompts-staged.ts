...
■ 검색 유입(SEO) 및 의료 신뢰(E-E-A-T) 강화 (P2 필수)
━━━━━━━━━━━━━━━━━━
🎯 검색 유입(SEO) 최적화
- 소제목은 검색어 형태로 작성 (예: "어지럼증 원인", "허리 통증 완화법")
- 핵심 키워드를 자연스럽게 포함 (과도한 반복 금지, 문맥 우선)
- 제목과 소제목에 키워드 전략적 배치

🏥 의료 신뢰(E-E-A-T) 확보
- 공포 마케팅 표현 절대 금지 (불안 조성 문구 제거)
- 과학적으로 무리한 수치/단정 회피
- 독자가 바로 실행 가능한 생활 습관 가이드 제공
- 명확한 문장, 구체적 행동 지침

❌ 공포 마케팅 금지:
"방치하면 돌이킬 수 없다", "생명이 위협받는다"
✅ 대안: "경과를 살펴보는 것도 방법이다"
...
💡 안전한 작성 방식 (권장)
- 일반적 증상/정보: "알려진 바에 따르면", "일반적으로"
- 구체적 통계 필요 시에만 출처 사용
- 출처 불확실/주제 불일치 시 절대 사용 금지
- 의심스러우면 출처 없이 일반화

🚨 출처 사용 시 필수 확인사항
- 웹 검색으로 찾은 URL을 출처로 사용하지 말 것
- 주제와 100% 일치하는 내용인지 확인
- 불확실하면 "최근 연구에 따르면"으로 일반화
- KDCA 동적 URL 사용 금지`;
...
□ 키워드 자연스러움 (P2)
   ...
   - 변형 표현 사용 확인
□ SEO 및 E-E-A-T 확인 (P2)
   - 소제목이 검색어 형태인지 ("어지럼증 원인", "허리 통증 완화법")
   - 공포 마케팅 표현 0개 ("방치하면 위험", "생명 위협")
   - 과학적 무리한 수치/단정 회피
   - 실행 가능한 생활 습관 가이드 포함
□ 종결어미 반복 (동일 표현 3회+ 탈락)
...
□ 마무리 문장 포함
□ 🚨 출처 3단계 검증 (P1 - 매우 중요)
   - 웹 검색 결과 URL을 출처로 사용하지 않았는지 확인
   - 주제와 100% 일치하는지 확인 (예: 어지럼증 주제에 당뇨/척추골절 출처 금지)
   - URL 실제 접근 가능 여부 확인
   - 불확실하면 출처 없이 "알려진 바에 따르면" 사용
