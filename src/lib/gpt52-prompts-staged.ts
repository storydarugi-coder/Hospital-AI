...
[P2] ⚠️ 반드시 준수:
  ...
  ⛔ 경고: 당신은 지금 HTML 태그를 글자로 세는 중입니다!
  ⛔ 1600자 목표인데 3100자 썼다고 착각하지 마세요!
  ⛔ <p>, </p>, <h2>, </h2> 이것들은 글자가 아닙니다!
  
  📐 **글자 수 계산 방법 (이것만 세세요!)**:
  
  🔥 단계 1: HTML 태그 완전 삭제
     "<p>안녕하세요</p>" → "안녕하세요"
     "<h2>제목</h2><p>내용</p>" → "제목내용"
  ...
  3️⃣ 모든 공백 삭제
  4️⃣ 남은 글자 세기
  5️⃣ ${textLength - 50} ~ ${textLength + 50} 범위인가?
  
  ✅ 범위 내 → 완료!
  ❌ 범위 밖 → 문장 추가/삭제해서 다시!
  
  💥 실제 사례:
  - 목표 1600자인데 3100자 썼다고 착각 ← 이거 하지 마세요!
  - 실제로는 2189자만 썼는데 HTML 포함해서 센 것!
  - 순수 텍스트만 세면 정확합니다!
