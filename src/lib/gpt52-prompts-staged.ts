...
🚨 산부인과 콘텐츠 금지 키워드 (P1 - 발견 즉시 전체 탈락):
❌ 임신/출산/아기/태아/분만/산모 - 완전 금지
❌ 임신 준비/임신 계획/임신 초기/임신 중 - 완전 금지
❌ 출산 계획/제왕절개/자연분만/산도 - 완전 금지
❌ 아이를 기다리는/아기를 갖기 위해 - 완전 금지
❌ 태아에게 영향/엄마가 되기 위해 - 완전 금지

⚠️ 산부인과 = 임신/출산만의 프레임 완전 제거!
  • 산부인과는 생리통, 질염, 자궁근종, 갱년기 등 일반 여성 건강을 다루는 곳
  • 임신/출산/아기 관련 내용은 미혼 여성이나 아이 계획 없는 분들을 배제함
  • 위 키워드 발견 시 해당 문단/섹션 전체 삭제 필수
