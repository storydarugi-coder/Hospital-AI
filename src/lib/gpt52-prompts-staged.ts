...
🎯 SEO 키워드 (사용자가 입력한 키워드):
  ...
  • 🚨 **여러 키워드가 있을 경우 순서별 차등 적용 (P1 - 절대 규칙!)**:
    - 첫 번째 키워드(가장 중요): **정확히 4회** (1500자 기준)
    - 두 번째 키워드: **최대 2회** (1500자 기준)
    - 세 번째 이후 키워드: **최대 1회** (1500자 기준)
  • ⚠️ 주의: 두 번째 키워드가 첫 번째보다 많이 나오면 즉시 탈락!
  • ⚠️ 예시: 두 번째 키워드 "자궁근종"을 3회 사용 ❌ → 반드시 최대 2회만!
  • 🔥 **부분 일치도 카운트**: "자궁근종" 2회 + "근종" 1회 = 총 3회 (위반!)
    - 두 번째 키워드가 "자궁근종"이면 "근종"도 카운트됨
    - "자궁근종" 2회 나왔으면 "근종"은 절대 사용 금지!
  • 글자 수에 따른 키워드 출현 횟수:
    - 1000자: 최소 2회
    - 1500자: 최소 3회 ⭐
    - 2000자: 최소 4회
