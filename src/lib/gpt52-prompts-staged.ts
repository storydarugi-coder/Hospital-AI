...
🎯 [ 분량 목표: 약 ${textLength}자 ]
📐 소제목 ${Math.max(4, Math.floor(textLength / 400))}개 | 문단 ${Math.max(8, Math.floor(textLength / 200))}개 | 문장 ${Math.max(20, Math.floor(textLength / 70))}개
...
[P2] ⚠️ 반드시 준수 - 구조 기반 분량 제어:
  
  📐 **분량 공식** (글자수 세지 말고 이 구조만 따르세요!):
  
  🎯 목표 ${textLength}자 = 아래 구조로 자동 달성됨:
  
  ┌─────────────────────────────────────────┐
  │ 소제목: ${Math.max(4, Math.floor(textLength / 400))}개                              │
  │ 소제목당 문단: 2개                       │
  │ 문단당 문장: 2~3개                      │
  │ 문장 길이: 35~45자                      │
  │ ───────────────────────────────────── │
  │ 총 문단: ${Math.max(8, Math.floor(textLength / 200))}개 | 총 문장: 약 ${Math.max(20, Math.floor(textLength / 70))}개         │
  └─────────────────────────────────────────┘
  
  📊 분량별 구조표:
  • 1500자 → 소제목 4개, 문단 8개, 문장 22개
  • 1600자 → 소제목 4개, 문단 8개, 문장 24개  
  • 2000자 → 소제목 5개, 문단 10개, 문장 29개
  • 2500자 → 소제목 6개, 문단 12개, 문장 36개
  
  ⚠️ 중요: 글자수를 세지 마세요! 구조만 맞추면 자동으로 맞습니다.
  
  ✓ 소제목 개수: ${Math.max(4, Math.floor(textLength / 400))}개 (고정)
    • 내용이 부족하면 문단 내용을 풍부하게
    • 내용이 넘치면 문장을 줄여서 조절
...
7. □ 🚨 분량 확인 - 구조 기반 체크:
   ...
   📐 **구조로 분량 검증** (글자수 세지 말고 구조만 확인!):
   
   🎯 목표 ${textLength}자 = 아래 구조 충족 시 자동 달성:
   ┌─────────────────────────────────────────┐
   │ ✅ 소제목(<h2>): ${Math.max(4, Math.floor(textLength / 400))}개                       │
   │ ✅ 총 문단(<p>): ${Math.max(8, Math.floor(textLength / 200))}개                       │
   │ ✅ 총 문장: 약 ${Math.max(20, Math.floor(textLength / 70))}개                      │
   │ ✅ 문장당: 35~45자                        │
   └─────────────────────────────────────────┘
   
   ⚠️ 글자수를 세려고 하지 마세요!
   ⚠️ 위 구조만 맞추면 분량이 자동으로 맞습니다!
