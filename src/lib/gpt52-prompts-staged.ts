...
5. 증상→질환→위험 판단 구조를 만들지 않음
   ...
   d) **'불안 유발 → 확인 유도 → 행동 촉구' 3단 구조 절대 금지**
      ❌ "이런 증상이 있다면 위험할 수 있습니다. 정확한 확인이 필요합니다. 전문가 상담을 받아보세요"
      ✅ "경우에 따라 상황이 다를 수 있습니다"
      → 불안→확인→상담 순서로 유도하면 광고로 판단
...
🎯 SEO 키워드 (사용자가 입력한 키워드):
  ...
  • 🚨 **여러 키워드가 있을 경우 순서별 차등 적용**:
    - 첫 번째 키워드(가장 중요): 4~5회 (1500자 기준)
    - 두 번째 키워드: 2~3회 (1500자 기준)
    - 세 번째 이후 키워드: 1~2회 (1500자 기준)
  • 글자 수에 따른 키워드 출현 횟수:
    - 1000자: 최소 2회
    - 1500자: 최소 3회 ⭐
    - 2000자: 최소 4회
