...
5️⃣ 마무리 문장:
  ✅ 반드시 중립적 안내로:
    • "전문적인 확인을 받아보는 것도 방법이다"
    • "상담을 통해 확인하는 것도 도움이 될 수 있다"
...
3. □ 금지어 전수조사 (Ctrl+F로 검색):
   ...
   □ 공포 표현: "위험", "위협", "경고", "심각", "치명"
   □ 과장 표현: "급증", "급격", "폭증", "사망"
   → 발견 개수: 0개 (시스템 프롬프트 대체어로 즉시 변경)
...
5. □ 인과관계 단정 검색:
   □ "유발", "초래", "~로 이어", "방치하면"
   → 발견 시 즉시 수정: "연관성이 있다", "관련이 있을 수 있다"
