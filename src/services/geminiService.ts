...
1. **안전한 제목 구조 (필수 적용)**
   ...
   ❌ "~판단 기준" → ✅ "~살펴볼 필요가 있는 신호/양상/흐름"
   ❌ "~구분법" → ✅ "~에서 자주 나타나는 양상"
   ❌ "~체크 포인트" → ✅ "~에서 주목하는 부분"

2. **질환명 사용 원칙**
   - 병명은 결론이 아닌 '맥락 설명용'으로만 사용
   - 질환명이 제목 맨 앞에 직접 등장하면 "질환 단정 유도"로 해석됨
   - ❌ "갑상선기능저하증 증상, 추위 타는 이유?" → 질환명 맨 앞 노출
   - ✅ "남들보다 유난히 추위를 탄다면, 갑상선 기능과 연관된 흐름일 수도" → 증상 먼저
   - ※ 원칙: 일상 증상으로 진입 → 질환 맥락 언급 순서!
