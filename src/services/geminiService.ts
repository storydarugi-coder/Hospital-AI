...
❌ 일반화: "모든", "누구나", "항상", "절대", "전부", "반드시"
   ❌ "모든 사람이 경험합니다"
   ✅ "경험하는 경우가 있어요"
❌ 의료용어: "의료", "의료진", "전문의", "의사", "진단", "처방", "검진"
...
"항상" → "때로" / "자주" / "종종"
"반드시" → "~하는 것도 방법" / "~할 수 있어요"

[❌ AI 냄새 - 즉시 탈락]
1. 나열: "~인지, ~인지, ~인지" 3개 이상
2. 접속사: "이처럼", "따라서", "그러므로" 과다 (전체 3회 미만)
3. 추상어: "불편함", "증상", "상태" 각 3회 미만
4. 정의형: "~이란?" / "~에 대해 알아보겠습니다" 금지
5. 백과사전: "체크포인트", "확인사항" 소제목 금지
6. 메타 설명: "오늘은 ~알아볼까요?", "~살펴보겠습니다", "이 글은 ~" 금지
7. 설명체: "~입니다", "~합니다" 연속 3회 금지 (말하듯 풀어쓰기)
8. 병원 홍보: 설득·권유·안내 톤 금지 (중립적으로)
9. 숫자 침투: "2~3주", "며칠", "몇 번", "여러 차례" 등 교묘한 숫자 표현 금지
10. 단정 침투: "~의 원인입니다", "~증상입니다", "필수입니다" 등 단정형 금지
11. 일반화 침투: "일반적으로", "보통", "흔히", "대부분" 등 일반화 금지

[✅ 글쓰기 원칙]
1. 톤: 중립·담담·관찰자 시점 (병원 홍보 느낌 제거)
2. 문체: 설명 ❌ → 상황 묘사 ✅
...
[✅ 글쓰기 핵심 3단계]
1. 도입 (2개 문단): 구체적 일상 상황 묘사
   ✅ "계단 내려갈 때마다 무릎이 '뚝' 소리와 함께 찌릿하게..."
   
2. 전개 (소제목당 2~3개 문단): 경험→원인→관찰 순서
   - 첫 문단: 현상 묘사 (설명 ❌)
   - 둘째 문단: 왜 그런지 관찰
   - 셋째 문단 (선택): 경험 사례
   - 감각 묘사 3개 이상: "찌릿", "뻐근", "욱신", "뻣뻣", "묵직", "시큰"
   - 상황 구체화: "앉았다 일어날 때", "아침에 처음 걷기 시작할 때"
   
3. 마무리 (1개 문단): 담담한 마무리 (권유 ❌)
   ✅ "몸이 보내는 신호를 알아차리는 것, 그것만으로도 의미가 있어요"

[✅ 리듬감]
1. 종결어미 순환 (연속 2회 금지, "~입니다" 연속 3회 금지)
...
[✅ 소제목]
❌ "무릎 통증이란?"
✅ "무릎에서 소리가 나는 이유" / "왜 아침에 더 뻣뻣할까?"

[HTML 구조]
<div class="naver-post-container">
  <p>도입 문단 1 - 구체적 상황 묘사</p>
  <p>도입 문단 2 - 공감</p>
  
  <h3>상황형 소제목 1</h3>
  <p>문단 1 - 현상 묘사</p>
  <p>문단 2 - 관찰</p>
  <p>문단 3 - 사례 (선택)</p>${targetImageCount >= 1 ? '[IMG_1]' : ''}
  
  <h3>공감형 소제목 2</h3>
  <p>문단 1 - 경험 서술</p>
  <p>문단 2 - 관찰</p>${targetImageCount >= 2 ? '[IMG_2]' : ''}
  
  <h3>실천형 소제목 3</h3>
  <p>문단 1 - 방법 제시</p>
  <p>문단 2 - 가능성</p>${targetImageCount >= 3 ? '[IMG_3]' : ''}
  
  <p>마무리 - 담담한 마무리</p>
  <p>#해시태그 10개</p>
</div>

⚠️ 소제목당 문단 개수: 최소 2개, 최대 3개 (필수!)
