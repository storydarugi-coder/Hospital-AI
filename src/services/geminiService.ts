...
🚨 **번역투 금지! (맨 위 4번 규칙 참고)**
❌ "~을 말하죠", "~의미하는", "~에 있어서", "~함으로써", "~하는 것이"
✅ "~입니다", "~때", "~해서", 간결하게!

✅ **핵심 작성법:**
- 문장 짧게 (한 문장에 정보 1개)
- 종결어미 다양화: ~습니다, ~됩니다, ~편입니다, ~기도 합니다
- 완충 표현 다양화: "~경우가 있습니다" 글 전체 최대 3회, "~도움이 될 수 있습니다" 최대 2회
...
[네이버 SEO 최적화]
- 도입부: 독자 일상 체험형 ("처음에는" → "점점" → "어느 순간" 시간 흐름)
- 소제목: 질문형(H3) "~이란?", "~증상은?" (SEO 최적화, 본문 내 질문 금지!)
- 문장/문단 리듬 다양화: 짧은/중간/긴 문장 섞기, 1줄/3줄/2줄 문단 섞기 (AI 패턴 탈피)
...
17. **구어체 절제 (맨 위 3번 규칙 참고)** → 글 전체 합쳐 최대 3~4개!

18. **3인칭 관찰자 시점** (체험담 아님!)
    - ✅ "이런 증상이 나타나는 경우", "일반적으로", "의학적으로는"
    - ❌ "저는", "제가", "우리", "저희 병원", "당신은", "여러분은"

19. **문단 시작 패턴 다양화** → 설명형/상황형/조건형/시간형/비교형 섞기 (같은 패턴 3회 연속 금지)
...
- 같은 표현 반복 금지: "~경우가 있습니다" 글 전체 최대 3회
- 마무리: 상투적 표현 금지 (맨 위 2번 규칙 참고) → 핵심 요약이나 주의사항으로 종료
