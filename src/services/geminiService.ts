...
export const refineContentByMedicalLaw = async (
  ...
  const prompt = `당신은 **최소 수정 + 사람 말맛 전문가**입니다.

🚨🚨🚨 P0 최우선 - "~요", "~죠" 체 완전 금지!!! 🚨🚨🚨
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❌ "~요" 절대 금지: "아프시죠", "힘드시죠", "좋아요", "있거든요", "~잖아요"
❌ "~죠" 절대 금지: "아시죠", "그렇죠", "맞죠"
✅ 반드시 "~습니다/~ㅂ니다" 체로만 작성!
   - "아프시죠" → "아픕니다"
   - "힘드시죠" → "힘듭니다"
...
🚨🚨🚨 핵심 원칙: 원본 구조 유지 + 사람처럼 쓰기! 🚨🚨🚨
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❌ 전체를 새로 쓰면 실패!
❌ 원본에 없는 소제목 추가 금지!
✅ 문제 있는 문장만 최소한으로 수정
✅ 원본 구조, 소제목, 문단 순서 100% 유지
...
3️⃣ 🗣️ AI 냄새 → 사람 말맛으로!
   ❌ "해당 증상이 지속되는 경우" → ✅ "이게 계속되면"
   ❌ "적절한 관리가 필요합니다" → ✅ "좀 신경 써야 합니다"
   ❌ "불편감이 발생합니다" → ✅ "뻐근합니다", "욱신거립니다"
...
✅ 일상 표현 사용:
- "움직이기 힘들어집니다" (활동에 제약 X)
- "잠을 잘 못 잡니다" (수면의 질 저하 X)
- "걸을 때 힘듭니다" (보행 시 불편 X)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{
  ...
  "fact_check": {
    ...
    "safety_score": 90,
    "ai_smell_score": 15,
    "issues": ["수정한 내용 1", "수정한 내용 2"],
    "recommendations": ["추가 권장사항"]
  }
}

⚠️ 반드시 "content" 키 사용! ("t", "c" 금지!)
⚠️ content에 전체 HTML 포함! (제목만 넣지 말 것!)`;
