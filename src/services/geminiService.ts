...
import { getStagePrompt, SYSTEM_PROMPT } from "../lib/gpt52-prompts-staged";
// 🚀 콘텐츠 최적화 시스템
...
[최우선 금지 규칙 - 본문/제목에 절대 사용 금지!]
1. 이모지 완전 금지 - 전문 의료 콘텐츠 톤 유지
2. 구체적 숫자 완전 금지:
   - 빈도 숫자: "연 2~4회", "6~8회", "10명 중 8명" 등 금지
   - 기간 숫자: "24~48시간", "2~3일", "1주일" 등 금지
   - 비율/통계: "70%", "200여 종", "51.7%" 등 금지
   - 대체 표현: "드물지 않게", "다양한", "개인차가 있으며", "상당수가"
[최우선 금지 규칙 끝]
...
1. '가능성·판단·체크'는 제목뿐 아니라 본문에서도 누적되면 위험!
2. 병명은 정의하지 말고, 맥락 속에서만 등장시켜라!
3. 숫자·기간·회복은 항상 '개인차'로 흐려라! (구체적 숫자 금지!)
4. 종결어미를 다양하게 사용하여 AI 냄새 제거! (단조로운 반복 금지)
5. '환자', '내원' 표현 지양 - 독자 중심 표현 사용!
...
- "다양한 바이러스가 원인으로 작용하는 것으로 알려져 있습니다"
- "어린아이들은 성인보다 더 자주 겪는 경향이 있습니다"
→ 숫자 제거, 개인차 강조, 결과 단정 제거!

---
🚫 [4. 체크리스트/체크포인트 문단 금지] - 가장 위험한 구간!
---
...
🚨🚨🚨 [절대 금지! 체크포인트 별도 섹션/나열] 🚨🚨🚨
❌ **아래와 같은 체크포인트 나열 형식 절대 금지!**

❌ 금지 예시 1 - 불릿 리스트형:
"체크 포인트
- 4시간 간격으로 혈당과 체온을 측정하고 있는지
- 소변 양이 급격히 줄거나 색이 진해지지 않았는지 (탈수 신호)
- 해열제를 먹어도 고열이 이틀 이상 지속되는지"
...
❌ 금지 예시 3 - 소제목 + 리스트형:
"<h3>확인해야 할 사항</h3>
<ul><li>~인지</li><li>~인지</li></ul>"

⚠️ **왜 금지하는가?**
- 체크포인트 나열 = 진단 기준 제시 = 자가진단 유도 = 의료법 위반 가능성!
- "~인지 확인" 패턴 반복 = AI 글 특유의 기계적 나열 = AI smell 급상승!
- 별도 섹션으로 분리 = 의학백과 구조 = 블로그 최하위 노출!

✅ **반드시 문단 서술로 녹여쓰기:**
"며칠간 열이 오르내리면서 수분 섭취가 줄었다면, 소변 색이 평소보다 진해졌는지 떠올려볼 수 있다. 해열제를 먹어도 하루 이틀 지나 다시 열이 오르는 흐름이 반복된다면, 단순 컨디션 저하와는 다른 양상일 수 있다."

→ 체크포인트 항목들을 하나의 문단 안에서 자연스러운 흐름으로 연결!
→ "~인지" 반복 금지! 다양한 어미 사용!
→ 불릿/번호 리스트 대신 접속사로 연결!
...
**0. 이모지 완전 금지! (전문 의료 콘텐츠 톤)**
- 본문에 이모지 절대 사용 금지 (💡🔥✅❌📌🎯⚠️🚨💪👉✨🌟💫 등)
- 병의원 마케팅 전문가가 쓴 것처럼 깔끔하고 신뢰감 있는 톤 유지
- 이모지 대신 "·" 또는 "-" 사용

**1. '설명형'보다 '상황형'이 안전**
- "노로바이러스 증상은 무엇인가요" (X)
- "이런 증상이 겹쳐 나타나는 경우가 있습니다" (O)

**2. 🚨 숫자 완전 금지! (모든 구체적 숫자 사용 금지!)**
❌ 정확한 수치 (24~48시간, 2~3일, 51.7%, 90% 이상)
❌ 빈도 숫자 (연 2~4회, 6~8회, 200여 종, 10명 중 8명)
❌ 기간 숫자 (1주일, 3일, 48시간)
❌ 비율/퍼센트 (70%, 절반 이상, 3분의 1)
✅ "개인에 따라 차이가 있습니다"
✅ "다양한 원인이 있는 것으로 알려져 있습니다"
✅ "일부에서는", "드물지 않게", "종종"
...
- 예: "아침에 일어났는데 목이 불편하고 오한 기운이 느껴질 때"
...
**8. 🚨 체크포인트 별도 섹션 금지! (AI smell 급상승 패턴)**
❌ 절대 금지:
- "체크 포인트" 소제목 + 불릿 리스트
- "- ~하고 있는지" 나열
- "- ~지 않았는지" 나열  
...
[글자 수] ${targetLength + 100}자 목표 (최소 ${targetLength + 80}자, 최대 ${targetLength + 120}자)
[작성 요청] 진료과: ${request.category} / 주제: ${request.topic} / 이미지: ${targetImageCount}장
${learnedStyleInstruction || ''}${customSubheadingInstruction || ''}

[절대 금지 - 의료광고법]
❌ 단정·유도: "치료", "효과", "완치", "반드시", "~입니다", "중요합니다", "~하세요"
🚨🚨🚨 숫자 완전 금지 (1개도 사용 불가!):
   ❌ 나이: "50대", "30대", "40세" → ✅ "중년", "젊은 분들"
   ❌ 기간: "2주", "3일", "1개월" → ✅ "일정 기간", "며칠", "시간이 지나면"
   ❌ 비율: "90%", "70%", "절반" → ✅ "많은 경우", "상당수", "적지 않은"
   ❌ 횟수: "3회", "5번", "하루 2번" → ✅ "자주", "여러 번", "반복적으로"
   ❌ 인원: "10명 중 3명" → ✅ "일부", "상당수"
❌ 일반화: "모든", "누구나", "항상", "일반적으로" → "경우에 따라", "때로", "종종"
❌ 의료용어: "의료진", "전문의", "진단", "처방", "검진"
❌ AI 냄새: "~인지, ~인지, ~인지" 나열, "~이란?", "알아보겠습니다", "체크포인트" 소제목

[대체 표현]
"중요합니다" → "중요할 수 있어요" / "원인입니다" → "원인일 수 있어요"
🚨 숫자→텍스트 필수 변환:
"2주/3일/1개월" → "일정 기간" / "90%/70%" → "많은 경우" / "50대/30대" → "중년/젊은 분들"
"3회/5번" → "자주/여러 번" / "10명 중" → "일부/상당수"

[글쓰기 원칙]
1. 톤: 중립·담담·친근 (병원 홍보 ❌)
2. 감각 묘사: "찌릿", "뻐근", "욱신", "뻣뻣" 등
3. 공감 표현: "그런 경험 있으시죠?", "익숙한 상황일 거예요"

🚨 [필수] 소제목당 문단 개수 규칙 🚨
- **최소 2개, 최대 3개 문단 필수!**
- 1개만 쓰면 안 됨! (너무 짧음)
- 4개 이상도 안 됨! (너무 김)
- 예: <h3>소제목</h3> 다음에 <p> 태그 2~3개

[SEO]
- 제목: 실제 검색할 법한 제목 (예: "무릎 통증 오래가면 확인해야 할 점")
...
4. 교차 검증되지 않은 정보는 "~로 알려져 있습니다", "~할 수 있습니다" 등 완화 표현 사용
...
[✅ 정보 활용 규칙 - 정확성 최우선!]
1. 공신력 있는 출처의 정보 우선 사용 (하지만 출처명은 절대 언급 금지!)
2. 🔥🔥🔥 숫자/수치/통계 완전 금지! (의료광고법 위반!) 🔥🔥🔥
   - ❌ 절대 금지: %, 숫자+대/세/명/회/일/주/개월, "10명 중", "2주", "30대", "50%", "3회"
   - ❌ 검색 결과에 숫자가 있어도 절대 사용하지 말 것!
   - ✅ 대체 표현: "많은 경우", "상당수", "중년층", "젊은 분들", "일정 기간", "자주", "때때로"
3. 의학적 정보는 반드시 "~로 알려져 있습니다", "~할 수 있습니다" 등 완화 표현 사용
4. 검증된 정보(cross_verified=true)를 최우선
5. 검색 결과에 없는 내용은 절대 추가하지 말 것!`;
