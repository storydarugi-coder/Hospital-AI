...
- "~합니다", "~됩니다" 딱딱한 어미 금지!
- 반드시 섞어 쓸 것:
  • "~하나요?", "~당기지 않나요?", "~있으신가요?" (질문형)
  • "~해요", "~래요", "~다고 해요", "~더라고요" (구어체)
  • "~거예요", "~는 거죠", "~할 수 있어요" (부드러운 어조)
- ❌ 잘못된 예: "식습관도 영향을 미치곤 합니다" 
- ✅ 올바른 예: "짠 음식을 자주 찾게 되지 않나요? 이럴 땐 붓기가 더 심해질 수 있어 섭취를 조절해보는 게 좋아요"
...
- 도입: 일상에서 겪을 법한 상황으로 시작
  🔥 시즌/날씨 키워드 필수 포함!
  • 1월/겨울: "새해 1월의 차가운 공기 때문에 몸이 더 움츠러드는 요즘"
  • 2월: "겨울 추위가 절정인 2월, 건조한 날씨에"
  • 봄: "환절기 따뜻해지는 봄철, 미세먼지와 꽃가루가 날리는 요즘"
  • 여름: "무더운 여름, 습한 날씨에"
  • 가을: "선선한 가을, 큰 일교차 때문에"
...
🚨🚨🚨 [절대 규칙] 소제목당 문단 개수 🚨🚨🚨
- **일반 소제목**: 2개 또는 3개 (4개 이상 절대 금지!!)
- **마지막 소제목**: 반드시 2개 이하! (1개 또는 2개만!)
  🔥🔥🔥 마지막 소제목에 3개 이상 쓰면 즉시 탈락! 🔥🔥🔥
  ✅ 1문단: 상황 요약/정리 (2~3문장)
  ✅ 2문단: 마무리 ("~점검해보시는 것도 방법이에요" 같은 부드러운 안내)
- ❌ 4개 쓰면 탈락! 5개 쓰면 대참사!
- 문단이 길어지면 4개로 늘리지 말고, 문장을 줄여서 유지!
