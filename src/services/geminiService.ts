...
- "~하는 것입니다", "~하기도 합니다"
- "~영향이 있다고 합니다", "~관련이 있습니다", "~와 연관성이 있습니다"
- "~로 나타납니다", "~하는 경우가 있습니다"
...
- 결론: **판단을 독자에게** 맡기기 (단정·강요 ❌)
  🔥 "전문가를 통해 객관적으로 확인" 금지!
  ✅ "통증 패턴이 매달 반복된다면 내 몸 상태를 한번 점검해보시는 것도 방법입니다"
...
- **마지막 소제목**: 🔴🔴🔴 정확히 2개 문단만! (절대 위반 불가!)
  ...
  ✅ 1문단: 상황 요약/정리 (2~3문장)
  ✅ 2문단: 마무리 ("~점검해보시는 것도 방법입니다" 같은 부드러운 안내)
  ❌ 절대 금지: 1개만 쓰기 (부족!)
...
🔴 [즉시 탈락!]
❌ 사용자가 요청하지 않은 부분 수정 → 즉시 탈락!
❌ 원본 길이의 ±20% 초과 → 즉시 탈락!
❌ 새로운 소제목 추가 → 즉시 탈락!
❌ 도입부/마무리 추가 → 즉시 탈락!
❌ 의료광고법 위반 표현 추가 → 즉시 탈락!
...
[HTML 형식] 블로그용 styled HTML 반환 (<div class="naver-post-container"> 사용)
🔴🔴🔴 절대 금지: 새로운 섹션 추가 (소제목 4~6개 기준 유지!)
🔴🔴🔴 일반 소제목: 문단 2~3개 / 마지막 소제목: 1~2개 (4개 이상 절대 금지!!)
...
🚨🚨🚨 [우선순위 1] 원본 길이와 구조 절대 유지! (탈락 기준)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📏 길이 제한:
• 원본 길이의 ±20% 이내로만 수정
• 원본 200자 → 160~240자 (이 범위 벗어나면 즉시 탈락!)
• 원본 500자 → 400~600자 (이 범위 벗어나면 즉시 탈락!)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
원본:
"잠자리 자세를 바꿔보는 것도 도움이 될 수 있습니다. 무릎 아래 쿠션을 받치면 허리가 편합니다. 옆으로 누우면 다리 사이에 베개를 끼웁니다."

❌ 나쁜 출력 (10문단으로 확장 - 즉시 탈락!):
"아침에 눈을 떴을 때 허리가 묵직합니다. [← 도입부 추가 ❌]
푹 자고 일어났는데도 몸이 개운하지 않습니다. [← 배경 설명 ❌]
밤새 뒤척이며 잠을 설친 날에는 불편합니다. [← 추가 확장 ❌]

잠자리 자세를 바꿔봅니다. [← 원본 시작]
무릎 아래 쿠션을 받치면 허리가 편합니다.
옆으로 누우면 다리 사이에 베개를 끼웁니다.

자고 일어날 때의 습관도 중요합니다. [← 추가 팁 ❌]
잠자리가 편안하면 하루가 달라집니다." [← 마무리 ❌]

→ 원본 3문장 → 10문장으로 확장 (즉시 탈락!)

✅ 좋은 출력 (3문장 유지 - 합격!):
"잠잘 때 자세를 바꿔봅니다. 무릎 아래 쿠션을 받치면 허리가 편해집니다. 옆으로 눕는다면 다리 사이에 베개를 끼웁니다."
...
✅ 수정 전 자가 체크리스트 (필수!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
수정을 완료했다면, 아래 항목을 반드시 확인하세요:

🔴 [페널티 시스템 - 즉시 탈락]
❌ 원본 문단 개수와 다르면 → 즉시 탈락! (3문단 → 3문단 유지 필수!)
❌ 원본 길이의 ±20% 벗어나면 → 즉시 탈락! (200자 → 160~240자만 허용!)
❌ 도입부 추가 → 즉시 탈락!
❌ 마무리 문단 추가 → 즉시 탈락!
❌ 배경 설명 추가 → 즉시 탈락!
❌ "추가 팁" 삽입 → 즉시 탈락!
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
원본:
"목과 어깨의 긴장이 지속되면 불편감이 나타날 수 있습니다. 장시간 같은 자세를 유지하면 목이 뻐근해질 수 있습니다. 스트레스가 쌓이면 어깨가 굳어질 수 있습니다. 정기적으로 스트레칭을 하면 도움이 될 수 있습니다. 전문가와 상담하는 것도 좋은 방법입니다."

❌ 나쁜 출력 (10문장으로 확장 - 즉시 탈락!):
"현대인들은 하루 종일 컴퓨터 앞에 앉아 있습니다. [← 배경 설명 추가 ❌]
이런 생활 패턴은 목과 어깨에 큰 부담을 줍니다. [← 추가 설명 ❌]
목과 어깨가 긴장하면 불편합니다. [← 원본 시작]
오래 같은 자세면 목이 뻐근합니다.
스트레스가 쌓이면 어깨가 굳습니다.
틈틈이 스트레칭합니다.
전문가와 상담도 방법입니다.
규칙적인 운동도 중요합니다. [← 추가 팁 ❌]
건강한 생활 습관을 유지하세요. [← 마무리 추가 ❌]"

→ 원본 5문장 → 10문장으로 확장 (즉시 탈락!)

✅ 좋은 출력 (5문장 유지 - 합격!):
"목과 어깨가 긴장하면 불편합니다. 오래 같은 자세면 목이 뻐근합니다. 스트레스가 쌓이면 어깨가 굳습니다. 틈틈이 스트레칭합니다. 전문가와 상담도 방법입니다."
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
원본 (200자):
"당뇨병 환자가 증가하고 있습니다. 특히 젊은 층에서도 많이 발견됩니다. 불규칙한 식습관과 운동 부족이 주요 원인으로 지목됩니다. 정기적인 건강검진을 통해 조기에 발견하면 관리가 가능합니다. 균형 잡힌 식단과 꾸준한 운동이 중요합니다. 전문의와 상담하여 자신에게 맞는 관리 방법을 찾는 것이 좋습니다."

❌ 나쁜 출력 (400자로 확장 - 즉시 탈락!):
"최근 건강검진 통계를 보면 당뇨병 환자가 급증하고 있습니다. [← 통계 추가 ❌]
과거에는 고령층의 질환으로 여겨졌지만, 이제는 젊은 층에서도 흔합니다. [← 배경 설명 ❌]
불규칙한 식습관과 운동 부족이 주요 원인입니다.
특히 배달 음식과 인스턴트 식품이 문제입니다. [← 예시 확장 ❌]
정기적인 건강검진으로 조기 발견이 가능합니다.
발견 후에는 식단 조절이 필수입니다. [← 추가 팁 ❌]
균형 잡힌 식단과 꾸준한 운동이 중요합니다.
하루 30분 이상 걷기를 추천합니다. [← 구체적 방법 ❌]
전문의와 상담하여 관리 방법을 찾습니다.
건강한 생활 습관을 유지하면 예방이 가능합니다. [← 마무리 ❌]"

→ 200자 → 400자로 확장 (즉시 탈락!)

✅ 좋은 출력 (220자 유지 - 합격!):
"당뇨 환자가 늘고 있습니다. 젊은 층에서도 많이 나타납니다. 불규칙한 식습관과 운동 부족이 원인으로 꼽힙니다. 정기 검진으로 조기 발견하면 관리가 가능합니다. 균형 잡힌 식단과 꾸준한 운동이 중요합니다. 전문의와 상담해 자신에게 맞는 방법을 찾습니다."
