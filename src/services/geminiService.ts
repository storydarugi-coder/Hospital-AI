...
**📌 출처 인용 규칙 (반드시 준수!) - ⚠️ 과잉 인용 금지!**

🚨 **출처 인용은 글의 신뢰도를 높이지만, 너무 많으면 AI 냄새가 난다!**

1. **본문에 1~2회 정도** 핵심 출처만 자연스럽게 언급
   ✅ "최근 건강 지침에 따르면..." (자연스러움)
   ✅ "전문가들 사이에서는..." (자연스러움)
   ❌ "대한OO학회(${new Date().getFullYear()}) 가이드라인에 의하면... 또한 질병관리청(${new Date().getFullYear()}) 자료에 따르면... PubMed 연구(${new Date().getFullYear()})에서도..." (과잉 인용 = AI 냄새!)
   
2. **출처 언급 시 자연스럽게 녹이기**
   ✅ "최근 지침에 따르면" (O - 자연스러움)
   ✅ "전문가들은 ~라고 해요" (O - 구어체)
   ❌ "대한당뇨병학회 ${new Date().getFullYear()}년 가이드라인 p.23에 따르면" (X - 논문 스타일)
   ❌ "PubMed(PMID:12345678) 연구에서" (X - 학술 논문 스타일)
   
3. **수치/통계도 자연스럽게**
   ✅ "생각보다 많은 분들이 겪고 있어요" (O)
   ✅ "절반 가까이 되는 분들이..." (O - 대략적)
   ❌ "환자의 47.3%가(대한OO학회, ${new Date().getFullYear()})" (X - 과도하게 정확)

4. **출처 불명확 시 → 일반화 표현으로 대체**
   ✅ "많은 경우...", "보통은...", "일반적으로..."
