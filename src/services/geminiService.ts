...
❌ 숫자: "50대", "2주", "90%", "3회" 등 → "중년", "시간이 지나면", "많은 경우", "자주"
...
<div class="naver-post-container">
  ...
  <h3>소제목 1 (상황형)</h3>
  <p>경험담</p>
  <p>이유</p>${targetImageCount >= 1 ? '[IMG_1]' : ''}
  
  <h3>소제목 2 (질문형)</h3>
  <p>경험담 + 감정</p>
  <p>이유</p>${targetImageCount >= 2 ? '[IMG_2]' : ''}
  
  <h3>소제목 3 (실천형)</h3>
  <p>생활 속 시도</p>
  <p>가능성</p>${targetImageCount >= 3 ? '[IMG_3]' : ''}
