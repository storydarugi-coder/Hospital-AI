...
✅ 대체: 이모지 제거하고 서술형으로!
   예: "🎯 인플루엔자의 특징" → "감기와는 좀 다른 흐름"
   예: "📌 주의해야 할 증상" → "조금 더 살펴볼 신호"
   예: "⚠️ 언제 병원에 가야 하나요?" → "감기약으로 버티기 어려운 신호"
   예: "✅ 검사 방법 안내" → "약국만으로 안 될 때"
...
- 🆕 딱딱한 설명조(~알려져 있습니다)를 의문형/청유형으로 섞기:
  ...
  ✅ "열이 갑자기 확 오르는 느낌을 경험하는 경우가 있다." (서술형)
...
- 🆕 서론에 구체적 상황 묘사 추가:
  ✅ "아침에 알람 끄는데 팔 들 힘도 없는 그 느낌을 경험하는 경우가 있다."
...
- 🆕 소제목 이모지 전부 제거하고 질문형으로 변경:
  ❌ "🎯 인플루엔자의 특징" → ✅ "감기와는 좀 다른 흐름"
  ❌ "📌 주의해야 할 증상" → ✅ "이런 증상이면 좀 더 살펴봐야 해요"
- 🆕 소제목을 환자의 실제 질문 형태로 변경 (더 자연스러움):
  ❌ "⚠️ 언제 병원에 가야 하나요?" → ✅ "감기약으로 버티기 어려운 신호"
  ❌ "✅ 검사 방법 안내" → ✅ "약국만으로 안 될 때"
