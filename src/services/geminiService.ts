...
7. 소제목은 질문형(H3)으로 작성 → "~이란?", "~증상은?", "~방법은?" (검색 의도 정확 매칭)
8. 완충 표현 적극 사용 → "~경우가 있습니다"(다수), "~알려져 있습니다", "~도움이 될 수 있습니다"
9. 구체적 숫자/시간은 필요 시에만 사용 → 자가 진단 방법, 예방 실천법 등에서 "40~60분마다", "약 1분간" (치료·효과 수치는 절대 금지)
10. 단락은 3~4줄 단위로 끊기 → 시각적 피로 최소화, 짧은 문장과 긴 문장 믹스
