...
1. **도입부: 관찰에서 시작하는 인사이트**
   ...
   ✅ "검사 결과지를 받아들고 '이게 무슨 뜻이지?' 싶었던 적이 있으실 것입니다."

2. **근거 인용 - 자연스럽게 녹이기** (2회 이내, 강조 X)
   ❌ "대한OO학회 가이드라인에 따르면..." (딱딱한 인용)
   ✅ "최근 가이드라인에서 눈에 띄는 변화가 있었습니다. 식후 혈당 관리를 더 강조하기 시작했습니다."
...
- 톤: 따뜻하고 이해심 있으면서도 전문적인 톤
- 문체: **"~습니다" 체 사용** (예: ~됩니다, ~있습니다, ~합니다)
- ⚠️ **절대 금지: ~해요, ~있어요, ~있죠, ~거예요, ~거죠 등 해요체/죠체 사용 금지!**
...
1. **도입부: 구체적 상황 묘사로 시작** (필수!)
   ...
   ✅ "샤워하고 나와서 5분만 지나도 온몸이 가려워지는 경험을 하시곤 합니다."
   ✅ "아침에 거울을 보다가 '어? 내 피부가 왜 이럴까?' 싶었던 적이 있으실 것입니다."

2. **구체적 상황/행동 예시 삽입** (최소 3개 이상)
   - 시간대: "아침 세안 후", "퇴근 후", "샤워 직후", "잠들기 전"
   - 장소: "히터 앞에서", "사무실 에어컨 아래서", "지하철 안에서"
   - 행동: "무의식적으로 긁다가", "보습제를 바르는데 따가워서", "화장이 들떠서"
   
3. **실패/예외 사례 포함** (AI 냄새 제거)
   ✅ "모든 보습제가 다 맞는 것은 아닙니다. 세라마이드 제품을 발랐다가 오히려 따가웠던 분들도 계십니다."
   ✅ "솔직히 이것을 알면서도 실천하기 어려운 것이 현실입니다."
   ✅ "병원에서 권하는 대로 했는데 별로 효과를 못 느끼는 분들도 계십니다. 개인차가 있기 때문입니다."

4. **강약 조절 - 모든 문장이 같은 톤 금지**
   - 강조: "이것은 매우 중요합니다", "꼭 기억해 두시기 바랍니다"
   - 약화: "사실은...", "솔직히 말하면...", "물론 개인차는 있습니다만"
   - 공감: "맞습니다, 귀찮은 일입니다", "쉽지 않은 일입니다"

5. **반복 표현 금지 - 다양한 표현 사용**
   ❌ "~에 도움이 될 수 있습니다" 반복 금지
   ✅ 대체 표현: "효과를 보시는 분들이 많습니다", "시도해볼 만한 가치가 있습니다", "의외로 괜찮은 방법입니다"

6. **🚨 "있어요", "있죠" 사용 제한**
   - 글 전체에서 "있어요", "있죠" 표현은 **최대 2번까지만** 사용
   - 과도한 사용 금지 (예: 한 문단에 3번 이상 사용 ❌)
   - 대체 표현 사용: "~있습니다", "~계십니다", "~됩니다"
   ✅ 올바른 예: "이런 경험을 하시는 분들이 있습니다", "그런 분들도 계십니다"

7. **🚫 번역투 표현 완전 금지**
   ❌ 절대 사용 금지 표현:
   - "기준점", "참고점", "시작점" → ✅ "기준", "참고 삼아", "출발선"
   - "측면에서" → ✅ "쪽에서", "관점에서"
   - "요소", "요인" → ✅ "이유", "원인"
   - "발생하다", "야기하다" → ✅ "생기다", "일어나다", "나타나다"
   - "제공하다", "제시하다" → ✅ "알려드립니다", "보여드립니다"
   - "고려하다", "검토하다" → ✅ "생각해보다", "살펴보다"
   - "활용하다", "시도하다" → ✅ "써보다", "해보다"

8. **🚫 수동태 표현 완전 금지**
   ❌ 절대 사용 금지:
   - "~되다", "~어지다" 형태의 수동태
   - "알려지다" → ✅ "알려져 있습니다" 또는 "~라고 합니다"
   - "권장되다" → ✅ "권장합니다", "권하고 있습니다"
   - "확인되다" → ✅ "확인했습니다", "확인할 수 있습니다"
   - "발견되다" → ✅ "발견했습니다", "찾아냈습니다"
   - "여겨지다" → ✅ "여깁니다", "봅니다"
   ✅ 능동태로 작성: "의사들이 권장합니다", "연구진이 확인했습니다"

⚠️ **중요: 반드시 "~습니다" 체를 사용하세요!**
⚠️ **절대 금지: ~해요, ~있어요, ~죠, ~거예요 등 해요체 표현 사용 금지!**
⚠️ **번역투와 수동태는 절대 사용하지 마세요! 자연스러운 한국어로 작성!**
⚠️ **모든 문장을 습니다체로 작성하세요!**
`,
...
4. **마무리: 열린 결론**
   ...
   ✅ "물론 아무것도 아닐 수도 있습니다. 그래도 한 번쯤 확인해보는 것이 마음이 편합니다."
...
4. 과도한 홍보 느낌 없이 정보 제공 형식으로
5. "~에서 상담받아보는 것도 방법입니다" 같은 완곡한 표현 사용
6. 병원명은 1회만 언급 (과도한 반복 금지)
7. 🚨 **중요: 병원 소개는 최소 5줄 이상, 7줄 미만으로 작성! (1개 문단)**
`;
