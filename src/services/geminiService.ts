...
1. **병원 선택 기준 제시 (CTA 핵심) - 구체적 방향성 필수!**
   - 추상적인 "전문의 상담"이 아니라 '어디로 가야 하는지' 방향성 제시
   ✅ "이런 경우에는 일반 감기 진료보다 목 상태를 직접 확인할 수 있는 진료가 필요합니다"
   ✅ "피부과보다 내과에서 원인을 먼저 파악하는 게 순서예요"
   ✅ "OO 검사를 바로 할 수 있는 의료기관에서 확인하세요"
   ✅ "OO 전문 진료 경험이 많은 곳을 찾아보세요"
   ❌ "병원에 가보세요" (너무 추상적)
   ❌ "전문의와 상담하세요" (방향성 없음)
