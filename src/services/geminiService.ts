...
<div class="press-release-container">
  ...
  <div class="press-body">
    ...
    <p>[의학적 맥락 설명 - "~할 수 있다", "~로 알려져 있다" 형태]</p>
    
    <p>[최근 증가 추세 - "최근 통계에 따르면", "의료계에서는" 등 완곡 표현]</p>
    
    <p>[질환 특성 - 초기 증상 특징, 단정 표현 금지]</p>
    
    <p>[검진·관리 중요성 - "권장된다", "중요하게 여겨진다" 수준]</p>
    ...
    <p>[병원 정보 간략히 - 환자 편의/진료 환경 수준, 장비 나열 금지]</p>
  </div>
