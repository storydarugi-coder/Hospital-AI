...
2. "~에 있어서", "~에 대해서", "~에 관해서" 과다 사용
   - ✅ "~에서", "~때", "~면"으로 간결하게
3. "~함으로써", "~하기 위해서는", "~하는 것이 필요하다"
   - ✅ "~해서", "~하려면", "~하면 좋습니다"로 자연스럽게
4. 피동태 과다: "되어진다", "이루어진다", "여겨진다", "주어진다"
   - ✅ "됩니다", "이뤄집니다", "여겨집니다"로 짧게
5. 관계대명사식: "~하는 것", "~인 것", "~된 것"
   - ✅ 동사로 바로 표현
6. "~을 통해", "~로 인해", "~에 의해" 과다
   - ✅ "~로", "~해서", "~때문에"로 간결하게
...
17. 🎨 **자연스러운 '불완전함' (AI 탈피!)**
    - ✅ 구어체 표현 가끔 삽입: "~거든요", "~잖아요", "~더라고요" (문단당 최대 1회)
    - ✅ 친근한 표현: "많은 분들이", "이런 경우", "때로는"
    - ✅ 자연스러운 전환: "그런데", "하지만", "다만" (과다 사용은 금지 - 5회 미만)
    - ❌ 금지: 오타, 맞춤법 오류, 문법 오류 (실제 실수는 절대 안됨!)
    - ❌ 금지: 지나친 구어체 ("ㅋㅋ", "ㅎㅎ", "~요~")
