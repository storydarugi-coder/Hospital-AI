...
✅ "아침에 일어나면 어깨 아프고 팔 올리기 힘들어요"
   → [시점: 아침] + [증상 조합: 어깨 아픔+팔 올리기 힘듦] (검색어 그대로)
...
2. **구체적인 주제**: "어깨통증" 대신 "겨울철 난방 후 어깨 불편함" 처럼 구체적으로
...
[🎯 출력 형식]
- topic: 구체적인 주제명 (예: "겨울철 어깨 불편함 원인")
- keywords: 블로그 제목에 쓸 롱테일 키워드 (예: "겨울 어깨통증, 난방 어깨 아픔, 아침 어깨 불편")
...
7. **너무 짧거나 키워드 나열식 제목 금지**
   ❌ "무릎 통증 원인" (키워드 나열)
   ❌ "어깨 아플 때" (너무 짧음)
   ✅ "아침마다 손가락이 불편한데, 움직이면 괜찮아지는 경우" (자연스러운 문장)
...
- "아침마다 손가락이 불편한데, 움직이면 괜찮아지는 경우" (구체적 장면)
...
[자연스러운 표현]
✅ 감각: "불편한", "뻐근한", "아픈", "당기는" (과장된 표현 피하기 - 예: "찌릿", "뻣뻣", "칼칼" → "불편한", "뻐근한", "아픈"으로 순화)
✅ 전환: "다만", "하지만", "그런데", "반대로", "의외로"
✅ 상황: "아침에 일어날 때", "계단 내려갈 때", "날씨가 흐린 날"
✅ 비유: 글에 1개 정도 자연스럽게 포함 (과도하지 않게)
...
□ 전환어: "이처럼", "따라서" 안 썼나?
□ 비유: 1개 정도 자연스럽게 포함했나? (과도하지 않게)
□ 감각 묘사: 과장되지 않은 표현 사용했나? (예: "찌릿", "뻣뻣" → "불편한", "뻐근한")
□ 숫자 표현: 모든 숫자 제거했나?
