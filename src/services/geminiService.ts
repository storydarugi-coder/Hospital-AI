...
`;
  ...
  // 🚀 v7.0 초경량 프롬프트 (112줄→45줄) - 타임아웃 방지 + 출처 표기 제거
  const blogPrompt = `
...
4. 종결: ~습니다/~편입니다/~겁니다 다양하게
5. 완화 표현: "~경우가 있습니다", "확인해보는 것도 방법"
6. 감각: "찌릿한", "뻣뻣한" OK, "칼칼", "뚝" 자제
7. 비유: 1개 정도 포함
...
<div class="naver-post-container">
  ...
  <p>설명</p>${targetImageCount >= 1 ? '[IMG_1]' : ''}
  <h3>주요 증상은?</h3>
  <p>증상</p>${targetImageCount >= 2 ? '[IMG_2]' : ''}
  <h3>관리 방법은?</h3>
  <p>방법</p>${targetImageCount >= 3 ? '[IMG_3]' : ''}
  <p>마무리</p>
  <p>#해시태그 10개</p>
</div>
