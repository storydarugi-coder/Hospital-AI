...
- "~도움이 됩니다" 최대 2회
- 같은 종결어미 3연속 금지
- 🚨 모든 숫자 절대 금지: 통계("90%"), 기간("2주", "3일"), 연도("2025년"), 배율("3배"), 연령대("50대") 등
- 🚨 의료진 직접 언급 최소화: "전문의", "의사", "전문가" → 대신 "진료를 통해", "확인이 필요", "점검" 등 간접 표현
- 추상명사 배제: "고려", "양상", "측면", "차원"
