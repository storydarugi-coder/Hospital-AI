...
[✅ 대체 표현]
"의료진 상담" → "전문가 상담" / "병원에서 확인"
"전문의 진단" → "정확한 확인" / "자세한 검사"
"받으세요" → "~하는 것도 방법" / "~하면 도움"
...
6. 메타 설명: "오늘은 ~알아볼까요?", "~살펴보겠습니다", "이 글은 ~" 금지
   ...
   ❌ "이 글은 무릎 건강에 초점을 맞췄습니다"
   ❌ "~참고할 수 있는 정보입니다"
   ✅ 바로 본론(구체적 상황)으로 시작!

[✅ 글쓰기 핵심 3단계]
1. 도입 (2개 문단): 구체적 일상 상황으로 시작
   ✅ "계단 내려갈 때마다 무릎이 '뚝' 소리와 함께 찌릿하게..."
   
2. 전개 (소제목당 2~3개 문단): 경험→원인→대응 순서
   - 첫 번째 문단: 핵심 설명
   - 두 번째 문단: 구체적 예시나 추가 설명
   - 세 번째 문단 (선택): 보충 정보
...
[✅ 리듬감]
1. 종결어미 순환 (연속 2회 같은 어미 금지)
   ~습니다 / ~편입니다 / ~곤 합니다 / ~수 있어요 / ~경우가 있습니다
...
<div class="naver-post-container">
  ...
  <p>문단 1 - 원인 설명</p>
  <p>문단 2 - 구체적 예시</p>
  <p>문단 3 - 추가 설명 (선택)</p>${targetImageCount >= 1 ? '[IMG_1]' : ''}
  
  <h3>공감형 소제목 2</h3>
  <p>문단 1 - 증상 서술</p>
  <p>문단 2 - 주의사항</p>${targetImageCount >= 2 ? '[IMG_2]' : ''}
  
  <h3>실천형 소제목 3</h3>
  <p>문단 1 - 관리 방법</p>
  <p>문단 2 - 실천 팁</p>${targetImageCount >= 3 ? '[IMG_3]' : ''}
