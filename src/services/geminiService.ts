...
✅ 정확한 목표: ${targetLength - 30}자 ~ ${targetLength + 30}자 범위 내 (±1.02배)
⚠️ 절대 부족 금지: ${targetLength - 50}자 미만이면 즉시 탈락!
⚠️ 절대 초과 금지: ${targetLength + 50}자를 넘으면 즉시 탈락!
...
4️⃣ **의료광고법 준수**
   ❌ 단정 표현: "치료됩니다", "개선됩니다", "완치"
   ❌ 수치: "90%", "3일 만에", "2주 후"
   ❌ 출처: "보건복지부", "질병관리청"
   ❌ 진단: "~증이 의심됩니다", "~병입니다"
   
   ✅ 가능성 표현: "도움이 될 수 있습니다", "나아질 수 있습니다"
   ✅ 마지막 문단에만: "살펴보는 것도 방법입니다" (권유 표현 OK)
