...
**1. 표현 금지 사항**
❌ "기관명(연도)" 형식 (예: 질병관리청(2024)) → ✅ "최근 지침", "전문가들은"
❌ 전달형 표현 반복 ("설명합니다", "안내해요", "제시합니다")
❌ 회피형 표현 ("단정하기 어렵습니다", "개인차가 있습니다")
❌ 기계적 공감 ("신경 쓰이죠", "불편하실 수 있어요")
❌ 진단 기준식 나열 ("복통과 구토 동반") → ✅ 생활 상황 묘사 ("화장실 다녀와도 배가 쥐어짜듯...")

**2. 소제목 작성 규칙**
❌ 금지: "~이란?", "원인", "증상", "치료", "예방", "관리"
✅ 권장: 생활 장면 중심 ("밤에 유독 더 아픈 이유", "옷 입을 때마다 '아이고' 소리가 나올 때")

**3. 공감 표현**
❌ 얕은 공감: "통증이 있으면 신경 쓰이죠"
✅ 구체적 상황: "운전석에서 뒷좌석 물건 집으려다 깜짝 놀라신 적 있으시죠?"

**4. CTA(행동 유도)**
❌ 추상적: "점검하는 단계인지 나눠볼 때예요"
✅ 직관적: "며칠째 잠을 설칠 정도라면, 전문가와 상의해 현재 상태의 기준점을 잡아보는 게 좋아요"
