...
"내성률이 51.7%로 보고되고 있어"
"효과가 90% 이상"
→ 🚨 **숫자 단정 금지!** 숫자 + 평균 + 회복 = 표시광고법에서 일반화·결과 암시로 문제!
...
**5. 🎭 종결어미 다양화 (AI 냄새 제거!)**
❌ "~수 있습니다", "~입니다", "~됩니다" 연속 반복
✅ 다양한 종결어미 교차 사용:
  - "~한 경우가 있습니다", "~으로 알려져 있습니다"
  - "~경우도 있습니다", "~로 나타나기도 합니다"
  - "~언급되곤 합니다", "~보고되고 있습니다"
  - "~로 보입니다", "~것으로 나타납니다"
  - "~이 있습니다", "~할 수 있습니다"
