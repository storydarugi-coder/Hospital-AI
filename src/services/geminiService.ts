...
🚨🚨🚨 [절대 규칙] 소제목당 문단 개수 🚨🚨🚨
- **무조건 2개 또는 3개!** (4개 이상 절대 금지!!)
- <h3>소제목</h3> 다음에 <p> 태그 **딱 2개 또는 3개만!**
- ❌ 4개 쓰면 탈락! 5개 쓰면 대참사!
- ❌ 1개만 쓰는 것도 안 됨!
- 문단이 길어지면 4개로 늘리지 말고, 문장을 줄여서 2~3개 유지!
...
🚨 각 소제목(<h3>) 다음에 <p> 태그 **딱 2개 또는 3개만!** (4개 이상 절대 금지!!)
