...
[🥇 1순위: 질병관리청 건강정보포털 - 반드시 제일 먼저 검색!]
• 질병관리청 건강정보포털: health.kdca.go.kr (일반인 대상 건강정보)
  → ⚠️ 이 사이트에서 충분한 자료를 찾았다면 해외 사이트(PubMed, CDC 등) 검색 생략!
...
[🚫 검색 제외 - 절대 수집 금지!]
⚠️ **외부 참조 완전 차단 정책 적용!**
- 블로그 (네이버 블로그, 티스토리, 브런치 등) - **절대 금지**
- 카페 (네이버 카페 등) - **절대 금지**
- SNS (인스타그램, 페이스북, 트위터 등) - **절대 금지**
- 유튜브, 틱톡 - **절대 금지**
- 광고성 사이트, 건강기능식품 홍보 사이트 - **절대 금지**
- 출처 불명의 건강 정보 사이트 - **절대 금지**
- **위에 명시된 허용 출처 외 모든 사이트** - **절대 금지**

⚠️ **허용 출처 목록에 없는 도메인은 절대 검색하거나 참조하지 마세요!**
⚠️ **외부 링크나 알 수 없는 출처의 정보는 절대 사용 금지!**
...
⚠️ **외부 참조 완전 차단 정책 - 허용 목록 외 모든 사이트 금지!**
❌ **블로그**: 네이버 블로그, 티스토리, 브런치, 개인 웹사이트 - **절대 금지**
❌ **커뮤니티**: 맘카페, 환우회, 디시인사이드, 지식iN - **절대 금지**
❌ **SNS/미디어**: 유튜브(의사 채널 포함), 인스타그램, 페이스북, 나무위키, 위키백과 - **절대 금지**
❌ **일반 건강매체**: 하이닥, 헬스조선, 코메디닷컴 등 (원문 인용 제외하고 기사 내용 자체 인용 금지) - **절대 금지**
❌ **위 허용 목록에 없는 모든 도메인** - **절대 금지**

⚠️ **중요:** 허용 출처(1~3순위) 목록에 없으면 절대 참조하지 마세요!
⚠️ **외부 링크, 알 수 없는 출처, 허용되지 않은 도메인은 전부 금지!**
