...
[수정 규칙]
1. 위의 모든 글쓰기 규칙을 100% 준수 (의료광고법, AI 냄새 제거, 문단 구조)
2. 자연스러운 경험담 + 감각 묘사 (찌릿한, 묵직한, 뻣뻣한 등)
3. 이미지 src는 __IMG_PLACEHOLDER_N__ 형식으로 유지
4. 🔄 중복 내용 금지! 도입부 내용을 본문에서 반복 ❌, 각 소제목은 서로 다른 정보!
5. 일반 소제목: 문단 2~3개 / 마지막 소제목: 1~2개 (4개 이상 절대 금지!!)
...
🚨🚨🚨 원본 길이 유지 (절대 준수!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. 원본 길이의 ±20% 이내로 수정 (절대 규칙!)
   - 원본이 200자 → 160~240자로 수정
   - 원본이 500자 → 400~600자로 수정
...
3. ✅ 해야 할 것:
   ✅ 원본 문장 수를 유지하세요 (3문장 → 3문장)
   ✅ 원본의 핵심 내용만 수정하세요
   ✅ 불필요한 부분은 삭제하세요 (추가 ❌)

4. 예시:
   원본: "잠자리 자세를 바꿔보는 것도 도움이 됩니다. 무릎 아래 쿠션을 받치면 허리가 편합니다."
   
   ❌ 나쁜 수정 (1,200자로 확장):
   "아침에 눈을 떴을 때 허리가 묵직합니다. 푹 자고 일어났는데도...
   (도입부 추가) + (본문 확장) + (추가 팁) + (마무리)"
   
   ✅ 좋은 수정 (길이 유지):
   "잠잘 때 자세를 바꿔봅니다. 무릎 아래 쿠션을 받치면 허리가 편해집니다."
