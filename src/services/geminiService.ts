...
`;
  ...
  // 🚀 v6.0 초경량 프롬프트 (230줄→60줄) - 타임아웃 방지
  const blogPrompt = `
...
글 쓰기 전 30초 분석:
1. 독자가 가장 궁금한 점 3가지는?
2. 핵심 메시지를 1문장으로 요약하면?
3. 어떤 톤이 적합? (안심형/설명형/비유형)
→ 분석 후 글 구조 설계!
...
[🚨 의료광고법 - 절대 금지]
❌ 단정: "치료된다", "낫는다", "효과가 있다", "반드시"
❌ 권유: "방문하세요", "내원하세요", "예약하세요", "전문의 상담", "병원 방문"
❌ 광고: "최고", "1등", "완치", "보장", "재생", "강화"
❌ 수치: 모든 숫자/통계/기간 절대 금지 ("90%", "10명 중 7명", "2주", "3일", "3배", "50대", "2025년" 등)
❌ 의료진 직접 언급: "전문의", "의사 선생님", "전문가" → 최대한 자제
❌ AI 패턴: "~인지, ~인지" 나열 / "이처럼", "따라서" (AI 전환어)
❌ 🔥 검증되지 않은 정보: 검색 결과에 없는 내용은 절대 지어내지 말 것!
✅ 안전: "~경우가 있습니다", "~편입니다", "개인에 따라 다릅니다"
✅ 완화 표현: "확인해보는 것도 방법", "점검이 필요할 수 있다"
✅ 🔥 출처 표기: 의학적 사실은 반드시 "질병관리청 자료에 따르면" 등 출처 명시

━━━━━━━━━━━━━━━━━━━━━━━
🔴 [정확성 최우선] P0 - 반드시 준수!
━━━━━━━━━━━━━━━━━━━━━━━

1. 🔥 검색 결과의 교차 검증된 정보(cross_verified=true)만 사용!
2. 🔥 의학적 사실은 100% 출처 명시! (예: "질병관리청 2026년 자료에 따르면...")
3. 🔥 불확실한 정보는 "~로 알려져 있습니다" 등 완화 표현 필수!
4. 🔥 검색 결과에 없는 내용은 절대 추가하지 말 것!
5. 🔥 통계/수치는 출처와 연도 없이 사용 금지!

━━━━━━━━━━━━━━━━━━━━━━━
🟡 [강력 권장] P1 - 자연스러운 글쓰기
━━━━━━━━━━━━━━━━━━━━━━━

[완충 표현 다양화] 같은 표현 최대 2회!
- ~모습을 보입니다 / ~편입니다 / ~쪽에 가깝습니다 / ~겁니다 / ~법입니다
- ~경우도 드물지 않습니다 / ~때도 있습니다 / ~이야기가 달라집니다
- ~개인차가 있습니다 / ~상황에 따라 다릅니다 / ~사람마다 느끼는 정도가 다릅니다
- ~살펴볼 필요가 있습니다 / ~주의가 필요합니다 / ~점검이 도움될 수 있습니다
- ~완화에 도움이 될 수 있습니다 / ~개선될 여지가 있습니다

[인간적 요소]
✅ 망설임: "정확히 어느 한 가지 원인이라고 보기는 어렵고"
✅ 대조: "~일 수도 있지만, 반대로 ~경우도 드물지 않습니다"
✅ 반전: "이상하게 들릴 수 있지만", "의외로"
✅ 선입견: "흔히들 ~라고 생각하지만, 실제로는"

[글쓰기 핵심]
1. 도입: 일상 체험으로 시작 (인사말/메타설명 금지)
2. 소제목: H3 질문형 "~이란?", "~증상은?"
3. 문장: 짧게 20~30자, 정보 1개씩
4. 종결: ~습니다/~됩니다/~편입니다/~기도 합니다/~겁니다/~법입니다 (다양하게)
5. 시점: 3인칭 ("저는/우리" 금지)
6. 마무리: "확인해보는 것도 방법입니다", "점검이 도움될 수 있습니다" (의료진 직접 언급 최소화)

[AI 냄새 제거]
- "~경우가 있습니다" 최대 2회 (3회 이상 반복 금지)
- "~도움이 됩니다" 최대 2회
- 같은 종결어미 3연속 금지 (입니다 5회 연속 금지)
- 추상명사 배제: "고려", "양상", "측면", "차원"
- 의학 용어 남발 금지: 일상 언어로 풀어쓰기

[자연스러운 표현]
✅ 감각: "찌릿한", "뻣뻣한", "불편한", "뻐근한" (OK) / "칼칼", "뚝", "쑤셔" 등 과도한 의성어는 자제
✅ 전환: "다만", "하지만", "그런데", "반대로", "의외로"
✅ 상황: "아침에 일어날 때", "계단 내려갈 때", "날씨가 흐린 날"
✅ 비유: 글에 1개 정도 자연스럽게 포함

━━━━━━━━━━━━━━━━━━━━━━━
📋 [작성 후 체크리스트]
━━━━━━━━━━━━━━━━━━━━━━━

□ 완충 표현 중복: 같은 표현 3회 이상 반복 안 됐나?
□ 종결어미 다양성: "~입니다" 5회 연속 안 됐나?
□ 전환어: "이처럼", "따라서" 안 썼나?
□ 비유: 1개 정도 자연스럽게 포함했나?
□ 감각 묘사: "찌릿", "뻣뻣" OK, "칼칼", "뚝", "쑤셔" 같은 과도한 의성어 자제했나?
□ 숫자 표현: 모든 숫자 제거했나?
□ 글자 수: ${targetLength + 80}~${targetLength + 120}자 사이인가?

[HTML 구조]
<div class="naver-post-container">
  <p>도입 (2~3문단)</p>
  <h3>${request.topic} 이란?</h3>
  <p>설명</p>${targetImageCount >= 1 ? '\n  [IMG_1]' : ''}
  <h3>주요 증상은?</h3>
  <p>증상</p>${targetImageCount >= 2 ? '\n  [IMG_2]' : ''}
  <h3>관리 방법은?</h3>
  <p>방법</p>${targetImageCount >= 3 ? '\n  [IMG_3]' : ''}
  <p>마무리</p>
  <p>#해시태그 10개</p>
</div>

[이미지]
텍스트/로고 금지, 스타일: ${imageStyleGuide}
...
━━━━━━━━━━━━━━━━━━━━━━━
🚀 작성 시작: STEP 0 분석 → 글 작성 → 체크리스트 점검 → JSON 응답
  `;
...
2. 🔥 통계/수치는 절대 출처 없이 사용 금지! 반드시 "질병관리청 ${getCurrentYear()}년 자료" 같은 명확한 출처 표기
3. 🔥 의학적 사실은 반드시 교차 검증된 정보(cross_verified=true)만 사용! 단일 소스 정보는 "~로 알려져 있습니다" 등 완화 표현 필수
4. 두 소스에서 상충되는 정보가 있다면 더 공신력 있는 출처(학회, 정부기관) 우선
5. 🔥 검색 결과에 없는 정보는 절대 지어내지 말 것! 불확실한 내용은 포함하지 않음
...
[✅ 정보 활용 규칙 - 정확성 최우선!]
1. 🔥 공신력 있는 출처(질병관리청, 의료기관, 학회, 정부기관)의 정보만 사용
2. 🔥 통계/수치는 100% 출처와 연도 필수! 예: "질병관리청 2026년 자료에 따르면..."
3. 🔥 의학적 정보는 반드시 "~로 알려져 있습니다", "~할 수 있습니다" 등 완화 표현 사용
4. 🔥 최신 정보를 적극 반영하되, 검증된 정보(cross_verified=true)를 최우선
5. 🔥 검색 결과에 없는 내용은 절대 추가하지 말 것! 불확실하면 생략!`;
