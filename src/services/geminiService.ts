...
████████████████████████████████████████████████████████████████████████████████
[🚨 AI 냄새 점수 시스템 - 블로그/언론 보도 필수 적용!]
████████████████████████████████████████████████████████████████████████████████

**⚠️ 총점: 100점 | 20점 초과 시 재작성 대상!**
**📌 적용 범위: 블로그, 언론 보도에 한정 (카드뉴스 제외)**

**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
**🔴 항목 1. 문장 패턴 반복도 (0~25점)**
**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
정의: AI 글은 문장 골격이 반복된다.

체크 포인트:
• "~일 수 있습니다"가 **연속 3회 이상** → +8점
• "~하는 경우가 많습니다" / "도움이 될 수 있습니다" 반복 → +5점
• 모든 문단이 같은 길이·리듬 → +5점
• 문장 시작이 "요즘 / 많은 분들이 / 일반적으로" 위주 → +7점

개선 힌트:
- 일부 문장은 말하듯이 끊기 (예: "근데요.", "그렇더라고요.")
- 관찰형 문장 섞기 (예: "실제로 ○○ 문의가 늘어납니다")
- 문장 엔딩 다양화: "~거든요", "~잖아요", "~인 경우도 있어요"

**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
**🟠 항목 2. 과도한 중립·완충 표현 밀도 (0~20점)**
**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
정의: 의료법을 지키다 너무 무색무취가 되면 AI 냄새가 난다.

체크 포인트:
• 한 문단에 "~일 수 있습니다" **2회 이상** → +6점
• 모든 문장이 가능성·조건부로만 끝남 → +8점
• 판단을 피하려다 정보도 흐려짐 → +6점

개선 힌트:
- "단정은 아니지만, 이런 경우엔 확인이 의미 있습니다" 처럼 조건+맥락 제시
- 조건부 표현 사이에 관찰/사실 문장 삽입
- 판단을 피하되 정보는 명확히 전달

**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
**🟡 항목 3. 현실 디테일 결핍 (0~20점)**
**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
정의: 구체적 맥락 없이 일반론만 나열하면 AI 냄새.

체크 포인트:
• 시간·계절·연령·생활 맥락 언급 없음 → +7점
• 실제 환자 질문/문의 유형 전무 → +7점
• 병원에서만 나오는 표현 부재 → +6점

개선 힌트:
- 관찰형 문장 1~2개 삽입 (예: "진료실에서 이런 질문 많이 받습니다")
- 계절/시간대 맥락 추가 (예: "아침에 일어났을 때 특히...", "환절기가 되면...")
- 연령대별 특성 언급 (예: "40대 이후로 이런 분들이 늘어나더라고요")

**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
**🟢 항목 4. 구조가 너무 교과서적임 (0~15점)**
**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
정의: 정의→원인→증상→치료→결론 구조는 AI 티가 난다.

체크 포인트:
• 소제목이 전형적 의학 교과서 순서 → +6점
• 독자 질문 없이 설명만 진행 → +5점
• 결론이 항상 "상담 받아보세요" → +4점

개선 힌트:
- 중간에 자가 점검 질문 1개 삽입 (예: "혹시 이런 증상 있으신가요?")
- 결론은 "지금 확인이 도움이 되는 이유" 제시 (단순 권유 X)
- 관찰→해석→정리 흐름으로 재구성

**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
**🔵 항목 5. 감정 없는 공감 문장 (0~10점)**
**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
정의: 공감이 형식적이면 오히려 AI 냄새.

체크 포인트:
• "걱정되실 수 있습니다" 류의 반복 → +5점
• 독자 상태를 넓게만 포괄 (구체성 없음) → +5점

개선 힌트:
- 회색지대 표현 삽입 (예: "솔직히 애매하죠", "어디까지 참아야 하나 싶을 때도 있어요")
- 구체적 상황 공감 (예: "병원 가자니 대단한 것 같고, 안 가자니 찝찝하고")

**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
**🟣 항목 6. CTA의 기계적 안전성 (0~10점)**
**━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━**
정의: 매번 같은 CTA는 AI 냄새.

체크 포인트:
• 매번 마지막 문장이 동일한 CTA → +6점
• 시점·이유 없는 '상담 고려' → +4점

개선 힌트:
- 시점 고정 + 조건 표현 (예: "이런 증상이 2주 이상 지속된다면")
- CTA 다양화: 배제형, 시점 고정형, 조건 제시형 혼용
...
|----------|------|------|
| 0~10점 | 사람 글 | ✅ 그대로 사용 |
| 11~20점 | 경계선 | ⚠️ 부분 수정 후 사용 |
| 21점 이상 | AI 냄새 확실 | 🚨 재작성 대상 |
...
**📝 작성 완료 후 자가 체크리스트:**
□ "~일 수 있습니다" 연속 3회 이상 없는가?
□ 각 문단에 관찰형/경험 문장 1개 이상 있는가?
□ 현실 디테일(시간/계절/연령)이 포함되어 있는가?
□ 교과서 구조가 아닌 자연스러운 흐름인가?
□ CTA가 시점/조건과 함께 제시되어 있는가?
□ **총점이 20점 이하인가?** → 초과 시 재작성!
...
`;
  ...
  const blogPrompt = `
    ...
    **중요: conversion_score가 100점이어도 의료법은 반드시 준수해야 합니다!**
    ...
    [🤖 AI 냄새 점수(ai_smell_score) 평가 기준 - 0~100점]
    **낮을수록 좋음! 20점 초과 시 재작성 필요**
    
    가점 항목 (점수가 높아질수록 AI 냄새가 심함):
    1. **문장 패턴 반복도** (0~25점)
       - "~일 수 있습니다" 연속 3회 이상 → +8점
       - "~하는 경우가 많습니다" 반복 → +5점
       - 모든 문단이 같은 길이·리듬 → +5점
       - 문장 시작이 "요즘/많은 분들이/일반적으로" 위주 → +7점
    
    2. **과도한 중립·완충 표현** (0~20점)
       - 한 문단에 "~일 수 있습니다" 2회 이상 → +6점
       - 모든 문장이 조건부로만 끝남 → +8점
       - 판단 회피로 정보가 흐려짐 → +6점
    
    3. **현실 디테일 결핍** (0~20점)
       - 시간/계절/연령/생활 맥락 없음 → +7점
       - 실제 환자 질문/문의 유형 전무 → +7점
       - 현장감 있는 표현 부재 → +6점
    ...
    **판정 기준:**
    - 0~10점: 사람 글 ✅ → 그대로 사용
    - 11~20점: 경계선 ⚠️ → 부분 수정 권장
    - 21점 이상: AI 냄새 🚨 → 재작성 필요
    
    **AI 냄새 줄이는 방법:**
    - 관찰형 문장 섞기 (예: "실제로 ○○ 문의가 늘어납니다")
    - 문장 엔딩 다양화: "~거든요", "~더라고요", "~인 경우도 있어요"
    - 구체적 맥락 추가 (시기, 대상, 상황)
...
[🚨 AI 냄새 점수 시스템 - 보도자료 필수 적용!]
**총점: 100점 | 20점 초과 시 재작성 대상**

**체크 포인트 (점수 높을수록 AI 냄새 심함):**
1. 문장 패턴 반복도 (0~25점)
   • "~일 수 있습니다" 연속 3회 이상 → +8점
   • 문장 시작이 "일반적으로/많은/요즘" 위주 → +7점
...
5. 형식적 공감 문장 (0~10점)
   • "관심이 높아지고 있다" 류의 반복 → +5점

6. CTA의 기계적 안전성 (0~10점)
   • 매번 같은 마무리 패턴 → +6점
...
**판정:** 0~10점=사람글(OK) | 11~20점=부분수정 | 21점↑=재작성
