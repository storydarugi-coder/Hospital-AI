...
❌ **인터넷 기사** - 출처가 불분명한 건강 기사, 헬스조선, 하이닥, 코메디닷컴 등 광고성 건강매체
❌ **포털 건강정보** - 네이버 지식백과 건강 섹션, 다음 건강 등 (학회 원문 직접 인용은 가능)
❌ **광고성 사이트** - 병원 홈페이지, 제약회사 홍보 페이지, 건강기능식품 사이트
❌ **민간요법/대체의학** - 한의학 관련 검증되지 않은 정보, 자연요법 사이트 등

🚨🚨🚨 **검색 결과 필터링 필수!** 🚨🚨🚨
Google 검색 시 위 출처가 결과에 나오면 **무시하고 넘어가세요!**
반드시 학회(.or.kr), 정부기관(.go.kr), 학술DB(pubmed, riss) 결과만 참고!
