...
[우선순위 1] 🎯 내용 확장 요청 감지!
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ 사용자가 "자세히/더 쓰기" 요청 → 내용 확장 허용!
• 원본 길이 제한 완화: +50%까지 확장 가능
• 요청한 부분만 확장 (전체 확장 금지!)
• 크롤링한 내용이 있다면 자연스럽게 녹여내기

🔍 Google Search 필수 사용!
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🚨 반드시 Google Search 도구를 사용하여 정보 검색!
• "질병관리청 [검색어]" 형태로 검색
• "보건복지부 [검색어]" 형태로 검색
• 대한의학회, 대한[전문과]학회 등 공신력 있는 기관 검색
• 검색한 정보를 바탕으로 정확한 내용 추가
• 출처는 절대 명시하지 말고, 사실만 자연스럽게 서술

✅ 올바른 확장 방법:
1. 요청받은 특정 부분만 확장
2. Google Search로 공공기관 정보 먼저 검색
3. 검색 결과 기반으로 정확한 정보 추가
4. 의료광고법 준수하며 내용 확장
5. 출처 명시 금지 (정보만 자연스럽게)

🚫 확장 시 금지사항:
❌ 전체 글 다시 쓰기
❌ 불필요한 부분까지 확장
❌ 의료광고법 위반 정보 추가
❌ Google Search 없이 AI 지식만 사용
` : `
[우선순위 1] 원본 길이 유지
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
• 원본 길이의 ±20% 이내로만 수정
...
🔍 Google Search 적극 활용:
• 질병관리청, 보건복지부 등 공공기관 최신 정보 필수 확인
• 검색한 내용을 자연스럽게 녹여 사실만 서술
• 출처는 절대 명시하지 말 것
• 의료 정보 정확성 검증 필수
