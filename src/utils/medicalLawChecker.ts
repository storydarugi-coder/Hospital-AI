...
export const FORBIDDEN_WORDS_DATABASE: ForbiddenWord[] = [
  ...
  { word: '최고', severity: 'critical', replacement: ['우수한', '전문적인'], reason: '비교 광고 금지 (의료광고법)', category: 'comparison' },
  { word: '1위', severity: 'critical', replacement: ['전문', '경험 많은'], reason: '비교 광고 금지 (의료광고법)', category: 'comparison' },
  { word: '최상', severity: 'critical', replacement: ['양질의', '우수한'], reason: '비교 광고 금지 (의료광고법)', category: 'comparison' },
  { word: '최고급', severity: 'critical', replacement: ['고품질', '우수한'], reason: '비교 광고 금지 (의료광고법)', category: 'comparison' },
  ...
  { word: '보증', severity: 'critical', replacement: ['기대됩니다', '도움이 됩니다'], reason: '보장성 표현 금지 (의료광고법)', category: 'guarantee' },
  { word: '획기적', severity: 'critical', replacement: ['효과적인', '유용한'], reason: '과장 광고 금지 (의료광고법)', category: 'exaggeration' },
  ...
  { word: '어디보다', severity: 'critical', replacement: ['(삭제)', '의료적으로'], reason: '비교 광고 금지 (의료광고법)', category: 'comparison' },
  { word: '전문가', severity: 'critical', replacement: ['의료진', '의사'], reason: '자격 강조 금지 (의료광고법)', category: 'exaggeration' },
  { word: '전문의', severity: 'critical', replacement: ['의료진', '의사'], reason: '자격 강조 금지 (의료광고법)', category: 'exaggeration' },
  { word: '명의', severity: 'critical', replacement: ['의료진', '의사'], reason: '자격 강조 금지 (의료광고법)', category: 'exaggeration' },
  { word: '베테랑', severity: 'critical', replacement: ['경험 있는', '의료진'], reason: '자격 강조 금지 (의료광고법)', category: 'exaggeration' },
  { word: '숙련된', severity: 'critical', replacement: ['경험 있는', '의료진'], reason: '자격 강조 금지 (의료광고법)', category: 'exaggeration' },
  { word: '전문적', severity: 'critical', replacement: ['의료적인', '의학적인'], reason: '자격 강조 금지 (의료광고법)', category: 'exaggeration' },
  { word: '전문', severity: 'critical', replacement: ['의료진', '의사'], reason: '자격 강조 금지 (의료광고법)', category: 'exaggeration' },
  ...
  // ===== Critical: 의료광고법 위반 (환자 표현/1인칭/정의형/행동유도/판단유도) =====
  { word: '환자', severity: 'critical', replacement: ['내원하시는 분', '찾아주시는 분'], reason: '환자 표현 지양 (의료광고법)', category: 'medical_law' },
  { word: '환자분', severity: 'critical', replacement: ['내원하시는 분들', '찾아주시는 분들'], reason: '환자 표현 지양 (의료광고법)', category: 'medical_law' },
  ...
  { word: '진료실', severity: 'critical', replacement: ['(삭제)', '임상에서'], reason: '의사 사칭 주의 (의료광고법)', category: 'first_person' },
  { word: '진료 현장', severity: 'critical', replacement: ['일반적으로', '임상에서'], reason: '의사 사칭 주의 (의료광고법)', category: 'first_person' },
