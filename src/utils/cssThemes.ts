...
export const CSS_THEMES: Record<CssTheme, {
  ...
  modern: {
    ...
    h3Style: 'font-size:26px; font-weight:800; color:#1a1a1a; margin:50px 0 20px; padding:15px 20px; background:#f8f9fa; border-left:5px solid #787fff; border-radius:8px;',
  ...
  premium: {
    ...
    h3Style: 'font-size:28px; font-weight:700; color:#2c2c2c; margin:60px 0 25px; padding-left:20px; border-left:4px solid #787fff;',
  ...
  minimal: {
    ...
    h3Style: 'font-size:24px; font-weight:700; color:#222; margin:55px 0 18px; padding-left:16px; border-left:3px solid #787fff;',
  ...
  warm: {
    ...
    h3Style: 'font-size:26px; font-weight:800; color:#c46d3d; margin:45px 0 22px; padding:18px 24px; background:#fff; border-left:5px solid #787fff; border-radius:15px; box-shadow:0 2px 10px rgba(120,127,255,0.15);',
  ...
  professional: {
    ...
    h3Style: 'font-size:25px; font-weight:800; color:#0066cc; margin:50px 0 20px; padding:16px 22px; background:#fff; border-left:6px solid #787fff; border-radius:6px;',
